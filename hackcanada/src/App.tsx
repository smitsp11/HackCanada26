          ...
          <div className="flex flex-col border border-black bg-studio shadow-[8px_8px_0px_rgba(0,0,0,1)]">
            ...
            <div className="flex flex-col p-6">
              <textarea
                ...
                className="w-full bg-transparent text-base leading-relaxed placeholder-black/25 outline-none resize-none border-b border-black pb-6 font-sans min-h-[120px]"
              />
                    ...
                    {assets.length === 0 ? (
                      ...
                      <>
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-px bg-black/10 border border-black/10">
                          {assets.map((asset) => (
                            <div key={asset.id} className="group/fig bg-studio flex flex-col">
